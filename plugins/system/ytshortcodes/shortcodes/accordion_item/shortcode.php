...
function accordion_itemYTShortcode($atts, $content = null){
	...
	$acc_item .=' '. $title . "</h3>";
	$acc_item .= "<div class='yt-accordion-inner' style='background:" . $background . ";color:".$color_desc.";border-color:".$color_title."'>" . parse_shortcode(str_replace(array("<br/>", "<br>", "<br />", "<p>","</p>"), " ", $content)) . "</div>";
	$acc_item .= "</li>";
