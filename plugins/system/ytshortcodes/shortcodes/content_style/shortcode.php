       ...
       $atts = ytshortcode_atts(array(
        ...
        switch ($atts['type_change']) {
		                ...
		                $icon_bg = ($atts['icon_bg']) ? 'style="background-color:'.$atts['icon_bg'].';"' : '';
		                    ...
		                    $return .= '<div class="yt-timeline-content">'."\n";
		                        $return .= '<div class="yt-timeline-content-body">'."\n";
		                            ...
		                            if ($atts['intro_text'] === 'yes' and isset($slide['introtext'])) {
		                                $return .=  '<div class="yt-timeline-item-text">'.parse_shortcode(str_replace(array("<br/>", "<br>", "<br />", "<p>","</p>"), " ", $slide['introtext'])).'</div>';
		                            }
			...
			case 'multiple_column':
				...
				$return = parse_shortcode(str_replace(array("<br/>", "<br>", "<br />", "<p>","</p>"), " ", $multiple_column));
				break;
			case 'slider':
				$slider='';
					$limit = 1;
				...
				$return = parse_shortcode(str_replace(array("<br/>", "<br>", "<br />", "<p>","</p>"), " ", $slider));
				break;
        	default:
        		$single_column = '';
				$limit = 1;
				...
				$return = parse_shortcode(str_replace(array("<br/>", "<br>", "<br />", "<p>","</p>"), " ", $single_column));
        		break;
        }
