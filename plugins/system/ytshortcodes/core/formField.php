			...
			case 'media':
				$html .= '<div class="yt-generator-img-picker-wrapper">
						...
						<div class="yt-generator-field-actions">
							<a class="btn modal btn-primary yt-generator-attr-src-a" title="Select image source" onClick="SqueezeBox.fromElement(this, {handler:\'iframe\', size: {x: 790, y: 580}}); return false;" href="index.php?option=com_media&view=images&tmpl=component&asset=&author=&fieldid=yt-generator-attr-' . $id . '&folder=" rel="{handler: \'iframe\', size: {x: 790, y: 580}}">
...
/* -------------------------------------------------------#icon-------------------------------------------- */
			case 'icon':
				...
				$html .= '<div class="yt-generator-icon-picker-wrapper">
							...
							<div class="yt-generator-field-actions">
								<a class="btn modal btn-primary yt-generator-attr-' . $id . '-a" title="Select image" onClick="SqueezeBox.fromElement(this, {handler:\'iframe\', size: {x: 790, y: 580}}); return false;" href="index.php?option=com_media&view=images&tmpl=component&asset=&author=&fieldid=yt-generator-attr-' . $id . '&folder=" rel="{handler: \'iframe\', size: {x: 790, y: 580}}">
									<i class="fa fa-image"></i>Select image
								</a>
								<a href="javascript:;" class="btn btn-warning yt-generator-icon-picker-button yt-generator-field-action">
				...
				$html  .= '<div class="yt-generator-isp">' . $sources;
					$html .= '<div class="yt-generator-isp-source yt-generator-isp-source-media">';
		        		$html .= '<div class="yt-generator-clearfix">';
		        			$html .= '<a class="btn modal button button-primary yt-generator-isp-add-media" title="Select image" onClick="SqueezeBox.fromElement(this, {handler:\'iframe\', size: {x: 830, y: 600}}); return false;" href="index.php?option=com_media&view=images&tmpl=component&asset=&author=&fieldid=yt-generator-attr-source&folder=" rel="{handler: \'iframe\', size: {x: 830, y: 600}}">';
