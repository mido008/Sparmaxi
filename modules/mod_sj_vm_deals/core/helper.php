...
abstract class VMDealsPHelper extends VMDealsBaseHelper {
	...
	public static function getList(&$params,$getC = 0)
	{
		...
		if(!empty($catids)){
			...
			$productModel = new VirtuemartModelProductDealExtend();
...
if(!class_exists('VirtuemartModelProductDealExtend') && class_exists('VirtueMartModelProduct') || class_exists('VMDealsHelper')){
	class VirtuemartModelProductDealExtend extends VirtueMartModelProduct{
