...
if(!empty($list)){
	...
	if($params->get('item_image_width')<250){
		$params->set('item_image_width',250);
	}
	
	if($params->get('item_image_height')<250){
		$params->set('item_image_height',250);
	}
...
?>
				...
				<?php if(!empty($items)) { ?>
					...
					<?php } ?>
						<div class="lt-item" style="width:<?php echo 100/$nb_cols; ?>%;" >		 
							<div class="sj_item_hovercard lt-item-inner">													
						        	...
						        	<div class="lt-arrow lt-right" >			
										<div class="lt-desc lt-right"  >     
       										<div class="lt-large-image" style="width:<?php echo $options->item_image_width ?>px; height:<?php echo $options->item_image_height ?>px;">       																															  											
												...
												<div class="lt-opacity"></div>
												<div class="lt-desc-inner">	
													<div class="lt-desc-inner-inner">																										
	...
	<?php if($options->item_short_decription_display==0) {?>
		#sj_vm_listing_<?php echo $uniquied ?> .lt-wrap-inner.theme4 .lt-item-inner .lt-icon{
			float:none;
			 padding:0;
		}
		#sj_vm_listing_<?php echo $uniquied ?> .lt-wrap-inner.theme4 .lt-item-inner .lt-icon .lt-icon-inner{
			float:none;
			margin:8px auto;
		}
		
		#sj_vm_listing_<?php echo $uniquied ?> .lt-wrap-inner.theme4 .lt-item-inner .lt-summary{
			text-align:center;
			white-space:nowrap;
			overflow:hidden;
			padding:0;
	...
	<?php if($options->price_display == 0){ ?>	
		#sj_vm_listing_<?php echo $uniquied ?> .lt-wrap-inner.theme4 .lt-arrow .lt-desc .lt-reviews{
			padding:0;
			border:none;
		}
	<?php }?>
