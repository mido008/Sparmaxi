 ...
 */
	...
	echo '<div class="owl-carousel owl-theme">';
		foreach($list as $index => $item){
		    ...
		    $percent = 0;
		    // 							print_r("<pre>");
		    // 							print_r($item->virtuemart_manufacturer_id[0]);
		    // 							print_r("</pre>");
		    switch ($item->virtuemart_manufacturer_id[0] )
		    {
		        case 1:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*150/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 2:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*75/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 3:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*66.7/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 4:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*50/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 5:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*60/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 6:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*50/100);
		            ...
		            break;
		        case 7:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*42.9/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 8:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*50/100);
		            ...
		            break;
		        case 9:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*44.4/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 10:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*40/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 11:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*33.4/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 12:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*28.6/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 13:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*150/100);
		            ...
		            break;
		        case 14:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*25/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 15:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*22.3/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 16:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*20/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 17:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*22.7/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 18:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*20.8/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		        case 19:
		            $discount_price = $item->prices['salesPrice'] + ($item->prices['salesPrice']*23/100);
		            $percent = (($discount_price-$item->prices['salesPrice'])/$discount_price)*100;
		            break;
		    }
